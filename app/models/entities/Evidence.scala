...
object Evidence {
  ...
  val evidenceImp = ObjectType(
    ...
    fields[Backend, JsValue](
      ...
      Field("Total_alterations/Patients_in_dataset",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "Total_alterations/Patients_in_dataset").asOpt[String]),
      Field("Total_primary_tumors_altered/Primary_tumors_in_dataset",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "Total_primary_tumors_altered/Primary_tumors_in_dataset").asOpt[String]),
      Field("Total_relapse_tumors_altered/Relapse_tumors_in_dataset",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "Total_relapse_tumors_altered/Relapse_tumors_in_dataset").asOpt[String]),
      ...
      Field("Kinase_domain_retained_Gene1A",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "Kinase_domain_retained_Gene1A").asOpt[String]),
      Field("Kinase_domain_retained_Gene1B",
            OptionType(StringType),
            description = None,
      ...
      Field("Reciprocal_exists_either_gene_kinase",
            OptionType(StringType),
            description = None,
            resolve = js => (js.value \ "Reciprocal_exists_either_gene_kinase").asOpt[String]),
      Field("Total_alterations_Over_Patients_in_dataset",
            OptionType(StringType),
            description = None,
