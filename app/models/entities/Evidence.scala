...
//Chop data fields
      ...
      Field("betaQ1",
        OptionType(StringType),
        description = None,
        resolve = js => (js.value \ "Beta_Q1").asOpt[String]),
      Field("betaQ2",
        OptionType(StringType),
        description = None,
        resolve = js => (js.value \ "Beta_Q2").asOpt[String]),
      Field("betaMedian",
        OptionType(StringType),
        description = None,
        resolve = js => (js.value \ "Beta_Median").asOpt[String]),
      Field("betaQ4",
        OptionType(StringType),
        description = None,
        resolve = js => (js.value \ "Beta_Q4").asOpt[String]),
      Field("betaQ5",
        OptionType(StringType),
        description = None,
        resolve = js => (js.value \ "Beta_Q5").asOpt[String]),
      Field("chopUuid",
        OptionType(StringType),
        description = None,
      ...
      Field("transcriptRepresentation",
        OptionType(StringType),
        description = None,
        resolve = js => (js.value \ "Transcript_Representation").asOpt[String]),
    )
  )
}