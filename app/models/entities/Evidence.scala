...
object Evidence {
  ...
  val evidenceImp = ObjectType(
    ...
    fields[Backend, JsValue](
      ...
      Field("disease_from_source_map_id",
            OptionType(StringType),
            description = None,
      ...
      Field("total_alterations_over_number_patients_in_dataset",
            OptionType(StringType),
            description = None,
      ...
      Field("total_relapse_tumors_altered_over_relapse_tumors_in_dataset",
            OptionType(StringType),
            description = None,
      ...
      Field("total_primary_tumors_altered_over_primary_tumors_in_dataset",
            OptionType(StringType),
            description = None,
